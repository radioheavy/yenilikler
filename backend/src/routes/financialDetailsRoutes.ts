...
export default (webSocketServer: WebSocketServer) => {
  ...
  router.get('/:id/realization-rate', (req, res) =>
    financialDetailsController.getRealizationRate(req, res),
  );
  router.get('/:id/average-investment', (req, res) =>
    financialDetailsController.getAverageInvestmentAmount(req, res),
  );
  router.get('/:id/extra-funding', (req, res) =>
    financialDetailsController.getExtraFundingAmount(req, res),
  );
  router.get('/:id/remaining-funding', (req, res) =>
    financialDetailsController.getRemainingFundingAmount(req, res),
  );
